...
public class MigratorHostedService(IServiceProvider serviceProvider, IHostEnvironment currentEnvironment) : IHostedService
{
    ...
    private static void AddEmployees(ClinicDbContext dbCtx)
    {
        ...
        [
            new Employee { Id = 1, Name = "Leandro", HospitalUnitId = 1, HospitalUnit = dbCtx.HospitalUnits.First(x => x.Id == 1), EmployeeNumber = "up201802127", Password = "735d7507b5410ee9b3dd1ea93bb60d31df0d2b1a", UserRoleId = 1, UserRole = dbCtx.UserRoles.First(x => x.Id == 1) },
            new Employee { Id = 2, Name = "Helena", HospitalUnitId = 1, HospitalUnit = dbCtx.HospitalUnits.First(x => x.Id == 1), EmployeeNumber = "up201405139", Password = "1c7ab2a24cdbcff89da653d7abf1ac856a8e530f", UserRoleId = 1, UserRole = dbCtx.UserRoles.First(x => x.Id == 1) },
            new Employee { Id = 3, Name = "John Doe", Address = "Baker Street", HospitalUnitId = 2, HospitalUnit = dbCtx.HospitalUnits.First(x => x.Id == 2), EmployeeNumber = "up201812345", Password = "5156ef0b70aa95a7290689040e046e4415841155", UserRoleId = 2, UserRole = dbCtx.UserRoles.First(x => x.Id == 2) }
        ];
